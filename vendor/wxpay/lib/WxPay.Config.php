...
class WxPayConfig {
    ...
    public static function initConfig($platform) {
        if( $platform == Constants::PLATFORM_WEB ) {
            ...
            self::$MCHID = '1487148162';
            self::$KEY = '279815d57b2ca513615ba11b95eaab77';
     ...
     * @var string
     */
    public static $APPID = 'wx2190f5a76591529a';
    public static $NOTIFY_URL = 'http://api.guimishuo1.com/xcx/wechatpay/notify';

    public static $MCHID = '1487148162';

    public static $KEY = '279815d57b2ca513615ba11b95eaab77';

    public static $APPSECRET = '5148ea72a4a98b9cd24c8ec7f0280b14';
